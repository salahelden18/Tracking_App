...
/// The state of a [StepCustom] which is used to control the style of the circle and
/// text.
///
/// See also:
///
...
/// A builder that creates the icon widget for the [StepCustom] at [stepIndex], given
/// [stepState].
typedef StepIconBuilder = Widget? Function(
    int stepIndex, StepStateCustom stepState);
...
class CustomStepper extends StatefulWidget {
  ...
  ///
  /// When overriding icon for [StepStateCustom.error], please return
  /// a widget whose width and height are 14 pixels or less to avoid overflow.
  ///
  /// If null, the default icons will be used for respective [StepStateCustom].
...
class _CustomStepperState extends State<CustomStepper>
  ...
  bool _isLabel() {
    for (final StepCustom step in widget.steps) {
      if (step.label != null) {
        return true;
      }
    }
      ...
      child: AnimatedContainer(
        ...
        child: Center(
          child: _buildCircleChild(index,
              oldState && widget.steps[index].state == StepStateCustom.error),
        ),
      ),
    );
  }
          ...
          child: CustomPaint(
            ...
            child: Align(
              ...
              child: _buildCircleChild(
                  index,
                  oldState &&
                      widget.steps[index].state != StepStateCustom.error),
            ),
          ),
        ),
      ),
  ...
  Widget _buildIcon(int index) {
    if (widget.steps[index].state != _oldStates[index]) {
      return AnimatedCrossFade(
        ...
        crossFadeState: widget.steps[index].state == StepStateCustom.error
            ...
            children: <Widget>[
              InkWell(
                onTap: widget.steps[i].state != StepStateCustom.disabled
                    ...
                    : null,
                canRequestFocus:
                    widget.steps[i].state != StepStateCustom.disabled,
      ...
      for (int i = 0; i < widget.steps.length; i += 1) ...<Widget>[
        InkResponse(
          onTap: widget.steps[i].state != StepStateCustom.disabled
              ...
              : null,
          canRequestFocus: widget.steps[i].state != StepStateCustom.disabled,
          child: Row(
            children: <Widget>[
              SizedBox(
